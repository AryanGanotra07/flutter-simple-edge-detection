              ...
              if (_croppedImagePath == null) {
                ...
                showModalBottomSheet<void>(
                    ...
                    builder: (context) {
                      ...
                      // _invoice.imgPath = _tempPath;
                      // _invoice.isProcessing = true;
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            RaisedButton(onPressed: () async {
                                              ...
                                              Helpers.showToast("Invoice sent for processing.");
                                            ...
                                            RaisedButton(onPressed: () async {
                                              Helpers.showToast("Saving to gallery..");
                                              GallerySaver.saveImage(_tempPath).then((value) => {
                                                Helpers.showToast("Saved to gallery!")
                                              });
